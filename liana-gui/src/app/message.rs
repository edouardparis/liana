...
pub enum Message {
    ...
    HistoryTransactionsExtension(Result<HistoryPage, Error>),
    HistoryTransactions(Result<HistoryPage, Error>),
    Payments(Result<PaymentsPage, Error>),
    PaymentsExtension(Result<PaymentsPage, Error>),
